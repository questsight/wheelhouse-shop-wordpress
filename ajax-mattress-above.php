...
<script>
  ...
  jQuery('#choice-mattress').on('click', function(){
    ...
    if(jQuery('.variation_id').attr('data-addpricetwo')){
      var addprice = parseInt(jQuery('.variation_id').attr('data-addpricetwo'), 10);
    }else{
      var addprice = 0;
    }
    ...
    jQuery('.variation_id').attr('data-addpricetwo',price);
